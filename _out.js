...
function VendedorPanel({ adm, members, referrals, jrReferrals, seekJrs, credentials, offers, passReqs, levelNotifs, onLogout, onAddMember, onUpdateMember, onDeleteMember, onUpdatePin, onAddReferral, onUpdateReferral, onTogglePaid, onDeleteReferral, onAddSeekJr, onDeleteSeekJr, onAddJrReferral, onToggleJrPaid, onDeleteJrReferral, onAddOffer, onDeleteOffer, onMarkRead, spinRewards, onMarkSold, onUpdateJrReferral, onToggleSpinPaid, onPayAllForSeek, onPayAllForJr }) {
  ...
  })(), view === "remuneracao" && /* @__PURE__ */ React.createElement(RemuneracaoPanel, { isMaster: false }), view === "fipe" && /* @__PURE__ */ React.createElement(FipeConsulta, null), !inSubView && view !== "fipe" && /* @__PURE__ */ React.createElement("div", { style: { position: "fixed", bottom: 74, left: "50%", transform: "translateX(-50%)", width: "calc(100% - 32px)", maxWidth: 576, zIndex: 19, padding: 0 } }, /* @__PURE__ */ React.createElement("button", { className: "btn btn-dark btn-full", style: { padding: 14 }, onClick: () => setShowExtrato(true) }, "\u{1F4CB} Extrato")), !inSubView && /* @__PURE__ */ React.createElement(AdmTabBar, { view, setView: (v) => {
    setView(v);
    setSelMember(null);
  ...
  function buildText() {
    ...
    if (role === "member") {
      ...
      return [
        ...
        ``,
        `\u{1F4B0} RESUMO FINANCEIRO`,
        `Valor Vendido: ${fBRL(totVol)}`,
        `Comiss\xE3o Total: ${fBRL(totCom + bonusR)} (comiss\xF5es + b\xF4nus)`,
        `A Pagar: ${fBRL(apagar)}`,
        bonusR > 0 ? `\u{1F3B0} B\xF4nus Roleta: ${fBRL(bonusR)} (discriminado)` : null,
        myJrs.length > 0 ? `
\u{1F465} SEEK JRs (${myJrs.length})` : null,
    ...
    if (role === "jr") {
      ...
      return [
        ...
        ``,
        `\u{1F4CA} DESEMPENHO`,
        `Total Indica\xE7\xF5es: ${referrals.length}`,
